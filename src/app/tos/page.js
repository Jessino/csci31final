          ...
          <div className="flex flex-col items-center">
            <div className="flex flex-col items-center w-3/4 text-center">
              ...
              <p className="mb-3">
                ...
                personality, etc.), whether you have social media (public) or private. If you have social media, I'd
                love to @ you after the completion of the commission if I had permission to post.
                <strong> Do's and Dont's: </strong> I am able to comfortably illustrate original characters, couples,
                some animals, humans with animalistic features (ears, tails, etc.), semi-details on armor, soft gore
                (nose bleed, etc.) and basic to medium backgrounds. I WILL NOT draw sexually explicit content, furries,
                hard gore, or full armor or background details. <strong> Payment Process: </strong> I will utilize Venmo
                only. NO REFUNDS! As the client, you will pay half up front and pay the rest after the commission has
                been completed. I will contact you within 48 hours of receiving the email or message. Commission
                cancellation will occur if the half payment isn't paid for after 48 hours of our agreement to begin the
                commission process. <strong> During the Process: </strong> We will stay in contact and communicate on
                the piece. Please be prepared and clear with an idea and come in with the details needed. I will
                continuously send W.I.Ps to show you my process and feel free to give me feedback! I will send the
                beginning sketches to give you options of what you want and will need an approval of you want (final
                draft). After completion, I will send the watermarked + unmarked (upon request) image.
              </p>
            </div>
          </div>
        </PageContentStyled>
